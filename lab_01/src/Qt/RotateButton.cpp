...
void RotateButton::UpdateUtilData() {
    ...
    m_pActionSlots->m_data->coordChangeData.rotateCoords.xRotateDegrees = std::stoi(xLine);
    m_pActionSlots->m_data->coordChangeData.rotateCoords.yRotateDegrees = std::stoi(yLine);
    m_pActionSlots->m_data->coordChangeData.rotateCoords.zRotateDegrees = std::stoi(zLine);
